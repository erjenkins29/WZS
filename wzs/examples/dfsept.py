...
sys.path.append('/opt/jupyter/Early Data/WZS')

import rankLP as rlp

df = pd.read_excel("/opt/jupyter/Early Data/WZS/data/merged201609.xls",index_col="egoodsid",encoding='gbk')
...
### removed "is_in_stock",since many NaN values in the file.[10/14]

removeThese = ["JD_Code","platform_brand_key", "is_in_stock","rating_score"]
